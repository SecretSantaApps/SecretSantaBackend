package ru.kheynov.services

import kotlinx.coroutines.*
import org.koin.core.component.KoinComponent
import org.koin.core.component.inject
import ru.kheynov.domain.entities.Notification
import ru.kheynov.domain.entities.NotificationMessage
...
class NotificationService : KoinComponent {
    ...
    private suspend fun notifyRoomUpdated(
        ...
        val users =
            if (forOwner) usersRepository.getUserByID(room.ownerId)?.clientIds ?: emptyList()
            else {
                gameRepository
